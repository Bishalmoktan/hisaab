...
import { PushNotificationSetup } from "@/components/push-notification/push-notification-setup";
            ...
            {groups.length === 0 ? (
              <Card className="border-2 border-dashed border-slate-200 bg-transparent shadow-none">
                <CardContent className="p-4 sm:p-6 lg:p-8 text-center">
                  ...
                  <p className="text-slate-500 font-medium text-xs sm:text-sm lg:text-base mb-1">
                    No groups yet
                  </p>
